    ...
    return (
        <Screen withoutScroll>
            ...
            <Screen unsafe style={{ paddingHorizontal: 15, }}>
                <Text size={17}>جهت پیشنـهاد یا انتقاد و یا از وجـود مشکلی در اپلیکیشن ماهـم می توانید به روش های زیـر ما را یاری نمـایید.</Text>
                <Divider />
                <Row style={{ justifyContent: 'space-between' }}>
                    <Text size={17}>ایدی تلگرام</Text>
                    <Text size={17}>Mahem_App</Text>
                </Row>
                <Row style={{ justifyContent: 'space-between' }}>
                    <Text size={17}>آدرس ایمیل</Text>
                    <Text size={17}>Mahem_App@gmail.com</Text>
                </Row>
                <Row style={{ justifyContent: 'space-between' }}>
                ...
                <Divider />
                <Text size={17}>تیم مدیریت و پشتیبانی ماهم در حال حاضر در تهران اقامت دارند و اقـدامات لازمه جهت انتقال دفتر به شـهر گنبد کاووس در دست اقـدام بوده و آدرس دقیق دفتر در گنبد کاووس اعلام خواهـد شد.</Text>
                <Text size={17}> در صورت ایجاد مزاحمت بـرای شما، می توانید با مراجعه به سایت
                    پلیس فـتا به آدرس www.cyberpolis.ir از اطلاعـات تماس
                    پلیس فتای محل سکونت خود آگاه شوید و موضـوع را از آن طریق پیگیری کنید.
                </Text>
                <Divider />
                <Row style={{ justifyContent: 'space-between' }}>

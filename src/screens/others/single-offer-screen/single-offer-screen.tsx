...
const singleProduct = {
    ...
    description: "تاریخ استفاده از 25/5/1402  تا 31/5/1402 \nامکان تست تا ۴۸ ساعت امکان پذیر است"
}
export function SingleOfferScreen() {
    ...
    const images = useMemo(() => {
        if (!!data?.data) {
            const imgs = Object.keys(data.data).filter(item => item.includes('image')).filter(item => !!data.data[item]).map(item => data.data[item].path)
            return imgs
        } else {
            return []
        }
                ...
                <View>
                    ...
                    <View style={{ ...styles.card, paddingHorizontal: 8 }}>
                        <View style={styles.badge1}>
                            <Text style={{ lineHeight: 20 }} size={15} color='white'>ویژگی ها</Text>
                        </View>
                    ...
                    <View style={{ ...styles.card, paddingHorizontal: 8 }}>
                        <View style={styles.badge1}>
                            <Text style={{ lineHeight: 20 }} size={15} color='white'>توضیحات</Text>
                        </View>
